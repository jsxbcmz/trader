...
| 设置页 | `app/pages/settings_page.py` | [.claude/pages/settings_page.md](.claude/pages/settings_page.md) — Token、图表配置 |
...
| 应用框架 | [.claude/modules/app_framework.md](.claude/modules/app_framework.md) | `app/main_window.py` + settings + thread |
