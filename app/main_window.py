...
from .pages import BrickPatternPage, MarketPage, ScoringPage, ScreeningPage, SettingsPage, StatsPage, TemplatePage
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.scoringPage = ScoringPage(self.root)
        ...
        self.pageStack.addWidget(self.scoringPage)
    ...
    def _setup_menu_bar(self):
        ...
        self.openScoringAction = view_menu.addAction("打开评分诊断页")
    ...
    def _connect_signals(self):
        ...
        self.scoringPage.statusMessageRequested.connect(self._show_status_message)
        self.openScoringAction.triggered.connect(lambda: self.switch_page(6))
